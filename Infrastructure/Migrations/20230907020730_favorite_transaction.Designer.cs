...
namespace BhdBankClone.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230907020730_favorite_transaction")]
    partial class favorite_transaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BhdBankClone.Core.Domain.FavoriteTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DestinationLoanId");

                    b.HasIndex("SourceAccountId");

                    b.HasIndex("SourceCreditCardId");

                    b.HasIndex("SourceDebitCardId");

                    b.HasIndex("TransactionTypeId");

                    b.ToTable("FavoriteTransactions");
                });
